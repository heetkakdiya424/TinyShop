...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query = mysqli_query($con, "update category set CategoryName='$catname',CategoryCode='$catcode' where id='$cid'");
            ...
            <div class="hk-pg-wrapper" style="background: #000000;">
                ...
                <div class="container">
                    ...
                    <div class="hk-pg-header">
                        <h4 class="hk-pg-title text-white"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Edit Category</h4>
                    </div>
                    <!-- /Title -->
