...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "insert into company(userID,CompanyName) values('$userID','$cname')");
        if ($query) {
            ...
            <div class="hk-pg-wrapper" style="background: #000000;">
                ...
                <nav class="hk-breadcrumb" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-light bg-transparent">
                        ...
                        <li class="breadcrumb-item active text-white" aria-current="page">Add Company</li>
                    </ol>
                </nav>
                <!-- /Breadcrumb -->
                ...
                <div class="container">
                    ...
                    <div class="hk-pg-header">
                        <h4 class="hk-pg-title text-white"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Add Company</h4>
                    </div>
                    <!-- /Title -->
