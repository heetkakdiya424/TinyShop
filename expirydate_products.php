            ...
            <div class="hk-pg-wrapper" style="background:#000000;">
                ...
                <div class="container">
                    ...
                    <div class="hk-pg-header">
                        <h4 class="hk-pg-title text-white"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Expiry Date Products</h4>
                    </div>
                    <!-- /Title -->
                                        ...
                                        <div class="table-wrap">
                                            <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    $exdate = mysqli_query($con, "SELECT * FROM  products where userID='$userID'");
