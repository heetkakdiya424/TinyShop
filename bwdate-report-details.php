                                        ...
                                        <div class="table-wrap">
                                            <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    $query = mysqli_query($con, "SELECT DISTINCT InvoiceNumber, CustomerName, CustomerContactNo, PaymentMode, InvoiceGenDate FROM  orders WHERE date(InvoiceGenDate) BETWEEN '$fdate' AND '$tdate' AND userID='$userID'");
                                                    $cnt = 1;
