            ...
            <div class="hk-pg-wrapper" style="background: #000000;">
                ...
                <div class="container">
                    ...
                    <div class="hk-pg-header">
                        <h4 class="hk-pg-title text-white"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>StockOut Products</h4>
                    </div>
                    <!-- /Title -->
                                        ...
                                        <div class="table-wrap">
                                            <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    // Fetch the stockout from the database
                                                    $stockout = mysqli_query($con, "select * from  products where userID='$userID'");
                                                    if ($stockout) {
                                                        // Create a DateTime object for the current date
                                                        $cnt = 1;
                                                        while ($row = mysqli_fetch_array($stockout)) {
