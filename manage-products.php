            ...
            <div class="hk-pg-wrapper" style="background: #000000;">
                ...
                <div class="container">
                    ...
                    <div class="hk-pg-header">
                        <h4 class="hk-pg-title text-white"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Manage Products</h4>
                    </div>
                    <!-- /Title -->
                                                ...
                                                <tbody>
                                                    <form method="POST" action="test.php">
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <style>
                                                                    /* Target the checkbox input element by its type */
                                                                    input[type="checkbox"] {
